...
func Index() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div id=\"splash-overlay\" class=\"splash-overlay\" aria-hidden=\"false\" aria-label=\"Welcome splash\"><button type=\"button\" id=\"splash-skip\" class=\"splash-skip-btn\" aria-label=\"Skip welcome animation\">Skip</button><div class=\"splash-grid\" aria-hidden=\"false\"><div class=\"splash-tile\"><img src=\"images/splash/IMG_0057.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_2265.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_2932.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_3149.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_4167.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_4760.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_5077.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_5725.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div><div class=\"splash-tile\"><img src=\"images/splash/IMG_8282.webp\" alt=\"\" loading=\"eager\" decoding=\"async\"></div></div></div><div class=\"index-hero card w-full flex-1 flex flex-col min-h-0 px-4\"><div class=\"flex-1 flex items-center justify-center relative z-[1]\"><div class=\"index-hero-content card-body items-center text-center p-0\"><h1 class=\"index-hero-title\">tat.it.too</h1><div class=\"index-hero-actions\"><a href=\"book.html\" class=\"btn btn-xl btn-hip btn-primary active:bg-black active:text-white hover:bg-black hover:text-white text-2xl font-semibold min-w-52\" rel=\"noopener\">Book Now</a> <a id=\"hero-flash-btn\" href=\"flash.html\" class=\"btn btn-xl btn-hip btn-primary active:bg-black active:text-white hover:bg-black hover:text-white text-2xl font-semibold min-w-52\" rel=\"noopener\">Flash</a></div></div></div></div><script>\n\t\t\tdocument.addEventListener('DOMContentLoaded', function() {\n\t\t\t\tvar overlay = document.getElementById('splash-overlay');\n\t\t\t\tvar skipBtn = document.getElementById('splash-skip');\n\t\t\t\tif (!overlay) return;\n\t\t\t\tfunction dismissSplash() {\n\t\t\t\t\toverlay.classList.add('splash-dismissed');\n\t\t\t\t\toverlay.setAttribute('aria-hidden', 'true');\n\t\t\t\t\tsessionStorage.setItem('tatit2SplashSeen', '1');\n\t\t\t\t}\n\t\t\t\tif (skipBtn) skipBtn.addEventListener('click', dismissSplash);\n\t\t\t\tvar lastPage = sessionStorage.getItem('tatit2LastPage');\n\t\t\t\tvar cameFromOtherPage = lastPage && lastPage !== '' && lastPage !== 'index.html';\n\t\t\t\tvar hasSeenIndex = sessionStorage.getItem('tatit2HasSeenIndex') === '1';\n\t\t\t\tif (cameFromOtherPage || hasSeenIndex || sessionStorage.getItem('tatit2SplashSeen') === '1') {\n\t\t\t\t\tdismissSplash();\n\t\t\t\t\treturn;\n\t\t\t\t}\n\t\t\t\tsetTimeout(dismissSplash, 1500);\n\t\t\t});\n\t\t</script>")
			if templ_7745c5c3_Err != nil {
